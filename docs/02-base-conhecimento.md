...
| Arquivo | Formato | Para que serve no Troquinho? |
|---------|---------|---------------------|
...
| `transacoes.csv` | CSV | Analisar padrão de gastos do cliente e usar essas infos de forma didática |
...
O produto Fundo Imobiliário (FII) substituiu o Fundo Multimercado, pois pessoalmente me sinto mais confiante em usar apenas produtos financeiros que eu conheço. Assim poderei validar as respostas do Troquinho de forma mais assertiva.
...
Existem duas possibilidades: Injetar os dados diretamente no prompt (Copia e cola) ou carregar os arquivos via código, como exemplo abaixo: 
